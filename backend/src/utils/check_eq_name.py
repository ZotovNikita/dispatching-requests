...
def check_eq_name(llm_model_url: str, title: str, body: str) -> str:
    ...
    Проанализируй, достаточно ли информации из письма для того, чтобы узнать название модели оборудования. Пример названия модели оборудования: НК2-1404 или ruc223012961 или CX-1015-12.
